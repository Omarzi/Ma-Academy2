...
class VisitorType extends StatefulWidget {
  static const String routeName = 'VisitorType';

  @override
  State<VisitorType> createState() => _Choose_turnState();
}

class _Choose_turnState extends State<VisitorType> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              InkWell(
                onTap: () {
                  Navigator.pushNamed(context, 'OnBoardingTeacher');
                },
              ...
              InkWell(
                onTap: () {
                  Navigator.pushNamed(context, 'OnBoardingParents');
                },
                child: CustomButtonTurn(
                  height: 12,
                  weidth: 50,
              ...
              InkWell(
                onTap: () {
                  Navigator.pushNamed(context, 'OnBoardingStudent');
                },
                child: CustomButtonTurn(
                  height: 11,
                  weidth: 60,
